$(function(){
	...
	$('#form').w2form({
		...
		{ name: 'dataHoraInicio', type: 'date', required: true, html: { caption: 'Data Início', attr: 'size="40" maxlength="16" readonly' } },
		{ name: 'horaInicio', type: 'time', required: true, html: { caption: 'Hora Início', attr: 'size="40" maxlength="16" readonly' } },
		{ name: 'dataHoraFim', type: 'date', required: true, html: { caption: 'Data Fim', attr: 'size="40" maxlength="64" readonly' } },
		{ name: 'horaFim', type: 'time', required: true, html: { caption: 'Hora Fim', attr: 'size="40" maxlength="64" readonly' } },
		{ name: 'dataHoraPrevisaoInicio', type: 'date', required: true, html: { caption: 'Data Previsão Início', attr: 'size="40" maxlength="32" readonly' } },
		{ name: 'horaPrevisaoInicio', type: 'time', required: true, html: { caption: 'Hora Previsão Início', attr: 'size="40" maxlength="32" readonly' } },
		{ name: 'dataHoraPrevisaoFim', type: 'date', required: true, html: { caption: 'Data Previsão Fim', attr: 'size="40" maxlength="32" readonly' } },
		{ name: 'horaPrevisaoFim', type: 'time', required: true, html: { caption: 'Hora Previsão Fim', attr: 'size="40" maxlength="32" readonly' } },
		{ name: 'descricao', type: 'text', required: true, html: { caption: 'Descrição', attr: 'size="40" maxlength="16" readonly' } },
		{ name: 'funcionario', type: 'list', required: true, options: {items: funcionario}, html: { caption: 'Funcionário', attr: 'size="40" readonly' } },
		{ name: 'tipoAtividade', type: 'list', required: true, options: { items: tipoAtividade }, html: { caption: 'Tipo Atividade', attr: 'size="40" readonly' } }
		],
		actions: {
			Reset: function () {
				this.clear();
